...
- **v2.11.1-ko.6** — 단어가 남았는지만 보는 방식을 문맥 중심 한국어 검토로 바꿨습니다. 교정 강도, 정상적인 인사, 공식 약속, 안전 강조, 개인 문체, 승인된 광고를 다루는 장르 지침과 의미 주장·기술 토큰을 나눠 확인하는 충실도 지침을 별도 문서로 추가했습니다. 항상 읽는 한국어 가이드를 축약하고 용어 지침을 작은 라우터와 과학·소프트웨어·의학·법률·금융 파일로 나눠 해당 분야만 불러오도록 했습니다.
