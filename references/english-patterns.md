...
Read this reference only when editing substantial English prose. It is extracted from upstream Humanizer v3.0.0 by `scripts/sync-english-patterns.py`. Do not edit it by hand.
